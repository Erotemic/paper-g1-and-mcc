...
\begin{abstract}
    ...
    % Remove provides insight, change to something explicitly states the relationship
    ...
    % TODO: might not want to phrase it as an update it looks weird. Also, the
    % previously published work just noted the result, but did not include the
    % proof. 
    %\emph{Update 2026--01--28:} 
    This result was previously noted in ecology literature in terms of the phi-coefficient and the Ochiai
      index, but we discuss it in the context of binary classifiers.
...
LLMs have begun to enable new workflows in math and science research.
Here, they were used to find the Lean 4 formalization of the proof and search for related work.

\paragraph{Formalization with LLMs}



The Lean proof shown in this paper was written using GPT 5.2. 
The first version was written using GPT-5.1~\cite{openai_gpt5_system_card}.
...
\renewcommand{\ie}{i.e.} % not sure why I needed to renew this command 
