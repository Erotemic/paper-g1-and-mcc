...
\begin{abstract}
    ...
    We also briefly comment the emerging role of LLMs in proof assistance and in locating prior work.
\end{abstract}
...
Building on that, GPT-5.2\cite{openai_gpt52_system_card} with extended thinking and manual feedback was able
  to produce the proof that better matches the structure of the original natural language argument, and is the
